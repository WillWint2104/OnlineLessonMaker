...
- [ ] Checked the **screenshots** artifact / will open the **live GitHub Pages** page after merge (there's no per-PR preview; do the live check on the school network for any delivery/firewall-affecting change)
